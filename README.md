...
<body>
  <div class="wrap">
    <div class="card">
      <h1>🎲 D&D Class Personality Quiz</h1>
...
<script>
  ...
  const DESCRIPTIONS = {
    Bard: "Expressive and social—you lead with creativity, charm, and encouragement.",
    Druid: "Grounded and adaptable—you trust instincts and the natural flow of things.",
    Fighter: "Steady and reliable—you face challenges head-on and hold the line.",
    Monk: "Disciplined and focused—you value self-mastery and calm under pressure.",
    Ranger: "Observant and prepared—you thrive in exploration, tracking, and awareness.",
    Rogue: "Clever and adaptable—you win with timing, strategy, and quick thinking.",
    Sorcerer: "Passionate and intuitive—your power comes from within and shows when it counts.",
    Warlock: "Mysterious and determined—you commit to a path and embrace power with consequences.",
    Wizard: "Curious and strategic—you love mastering systems and solving complex problems."
  };

  const QUESTIONS = [
    {
      text: "When faced with a problem, you usually…",
      options: [
    ...
    {
      text: "In a group, your role tends to be…",
      options: [
    ...
    {
      text: "Magic feels most meaningful when it is…",
      options: [
    ...
    {
      text: "In a dangerous situation, you’re most likely to…",
      options: [
    ...
    {
      text: "Your approach to power is…",
      options: [
    ...
    {
      text: "Victory feels best when you win by…",
      options: [
    ...
    {
      text: "Your inner drive is mostly about…",
      options: [
  ...
  function renderQuestion() {
    ...
    q.options.forEach((opt, optIndex) => {
      ...
      const chosen = answers[idx] === optIndex ? " ✅" : "";
  ...
  function showResults() {
    ...
    title.textContent = top.length === 1 ? `Your class is: ${top[0]} 🎉` : `You’re a blend: ${top.join(", ")}`;
    desc.textContent = top.length === 1 ? DESCRIPTIONS[top[0]] : "Your answers strongly matched multiple classes—try again with different instincts to break the tie!";
  ...
  shareBtn.onclick = async () => {
    ...
    if (navigator.share) {
      ...
      try {
        ...
        shareHint.textContent = "Copy failed—just copy the address bar link.";
      }
    }
  };
